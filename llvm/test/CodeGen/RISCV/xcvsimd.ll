...
define i32 @test.cv.insert.bcomplex(i32 %a, i32 %b, i32 %c, i32 %d) {
; CHECK-LABEL: test.cv.insert.bcomplex:
; CHECK:       # %bb.0:
; CHECK-NEXT:    mv a4, a0
...
define i32 @test.cv.insert.hc(i32 %a, i32 %b) {
; CHECK-LABEL: test.cv.insert.hc:
; CHECK:       # %bb.0:
; CHECK-NEXT:    mv a2, a0
; CHECK-NEXT:    # implicit-def: $x10
...
define i32 @test.cv.packhi.b1(i32 %a, i32 %b, i32 %c) {
; CHECK-LABEL: test.cv.packhi.b1:
; CHECK:       # %bb.0:
; CHECK-NEXT:    cv.packhi.b a0, a1, a2
; CHECK-NEXT:    ret
  %1 = call i32 @llvm.riscv.cv.simd.packhi.b(i32 %a, i32 %b, i32 %c)
...
define i32 @test.cv.packlo.b1(i32 %a, i32 %b, i32 %c) {
; CHECK-LABEL: test.cv.packlo.b1:
; CHECK:       # %bb.0:
; CHECK-NEXT:    cv.packlo.b a0, a1, a2
; CHECK-NEXT:    ret
  %1 = call i32 @llvm.riscv.cv.simd.packlo.b(i32 %a, i32 %b, i32 %c)
...
define i32 @test.cv.extract.h255(i32 %a) {
; CHECK-LABEL: test.cv.extract.h1:
; CHECK:       # %bb.0:
...
define i32 @test.cv.extract.b255(i32 %a) {
; CHECK-LABEL: test.cv.extract.b1:
; CHECK:       # %bb.0:
...
define i32 @test.cv.extractu.h255(i32 %a) {
; CHECK-LABEL: test.cv.extractu.h1:
; CHECK:       # %bb.0:
...
define i32 @test.cv.extractu.b255(i32 %a) {
; CHECK-LABEL: test.cv.extractu.b255:
; CHECK:       # %bb.0:
